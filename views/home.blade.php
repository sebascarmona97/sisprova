    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <!--   <ul class="treeview-menu">
            ...
            <li class="active"><a href="index2.html"><i class="fa fa-circle-o"></i> EDITAR</a></li>
            <li class="active"><a href="index2.html"><i class="fa fa-circle-o"></i> ELIMINAR</a></li>
            <li class="active"><a href="index2.html"><i class="fa fa-circle-o"></i> VER</a></li>
          </ul> -->
        </li>
        <li class="treeview">
          <a href="#">
 ...
 -->            </span>
        ...
        <li>
          <a href="pages/widgets.html">
            <i class="fa fa-th"></i> <span>COMPLEJO</span>
            <span class="pull-right-container">
       ...
       <!--        <i class="fa fa-angle-left pull-right"></i> -->
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>PRIVILEGIOS</span>
            <span class="pull-right-container">
    <!--           <i class="fa fa-angle-left pull-right"></i> -->
            </span>
          </a>
        ...
        <li>
          <a href="pages/calendar.html">
            <i class="fa fa-calendar"></i> <span>TIPO DE EQUIPO</span>
            <span class="pull-right-container">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-folder"></i> <span>TIPO DE VEHICULO</span>
            <span class="pull-right-container">
<!--               <i class="fa fa-angle-left pull-right"></i> -->
            </span>
          </a>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-share"></i> <span>VEHICULO</span>
            <span class="pull-right-container">
            <!--   <i class="fa fa-angle-left pull-right"></i> -->
            </span>
          </a>
